...
const Landing = () => {
  ...
  return (
    ...
    <div
      className="min-h-screen bg-black text-[#e3d5ba] antialiased font-sans flex flex-col justify-between relative px-6 md:px-12 selection:bg-[#51432d] selection:text-white"
      style={{
